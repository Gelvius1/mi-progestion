export default function initToastsPlugin() {
    class SwipeHandler {
    ...
    class ToastsFactory {
		...
		createToastsContainer() {
			const existingContainer = document.querySelector('.toasts-container');
			
			if (existingContainer) {
				this.toastsContainer = existingContainer;
				return;
			}
    ...
    return new ToastsFactory(swipeHandler);	
